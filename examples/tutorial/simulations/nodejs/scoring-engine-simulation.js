 ...
 */
 ...
 var deployr     = require('deployr'),
     ...
     printHelper = require('../../../utils/rbroker-stats-helper');
...
ScoringEngineSimulation.prototype = {
   ...
   simulateApp: function(pBroker) {
      ...
      if (typeof window === 'undefined') {
         ...
         RIn = deployr.RInput; // `deployr` already in window for browsers
      }
      ...
      for (var tasksPushedToBroker = 0; tasksPushedToBroker < SIMULATE_TOTAL_TASK_COUNT; tasksPushedToBroker++) {
...
module.exports = ScoringEngineSimulation;